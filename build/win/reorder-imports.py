...
def main(argv):
    usage = (
        'reorder_imports.py -i <input_dir> -o <output_dir> '
        '-a <target_arch> [-n <exe_name>]'
    )
    ...
    parser.add_option(
        '-n',
        '--name',
        help='executable name (default chrome.exe)',
        default='chrome.exe',
    )
