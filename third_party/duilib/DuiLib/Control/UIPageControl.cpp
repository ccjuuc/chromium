...
#define PAGE_OPT_GROUP _T("PAGE_OPT_GROUP")
    ...
    void DuiLib::CPageControlUI::SetMaxPages(int nPages, int nShowNum )
    {
    ...
    void DuiLib::CPageControlUI::SetMaxChar(int nNum )
    {
    ...
    void DuiLib::CPageControlUI::SetPageSelectedTextColor(DWORD cr )
    {
        m_dwSelTextColor = cr;
        for (int i = 0; i < m_OptPageNoArr.GetSize(); i++)
        {
    ...
    void DuiLib::CPageControlUI::SetPageNormalTextColor(DWORD cr )
    {
    ...
    void DuiLib::CPageControlUI::SetPageBkColor(DWORD cr )
    {
    ...
    void DuiLib::CPageControlUI::SetPageNoSize(int w , int h )
    {
        m_szPage.cx = w;
        m_szPage.cy = h;
        UpdatePosition();
    ...
    void DuiLib::CPageControlUI::SetGotoEditSize(int w , int h )
    {
        m_szGotoEdit.cx = w;
        m_szGotoEdit.cy = h;
        UpdatePosition();
    ...
    void DuiLib::CPageControlUI::SetGotoEditBorderColor(DWORD cr )
    {
        m_EdtPageNo->SetBorderColor(cr);
    }

    void DuiLib::CPageControlUI::SetGotoEditBorderSize(int size )
    {
