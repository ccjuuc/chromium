...
LRESULT CWindowWnd::SendMessage(UINT uMsg, WPARAM wParam , LPARAM lParam )
{
    ASSERT(::IsWindow(m_hWnd));
    return ::SendMessage(m_hWnd, uMsg, wParam, lParam);
}

LRESULT CWindowWnd::PostMessage(UINT uMsg, WPARAM wParam , LPARAM lParam )
{
    ASSERT(::IsWindow(m_hWnd));
    return ::PostMessage(m_hWnd, uMsg, wParam, lParam);
}

void CWindowWnd::ResizeClient(int cx , int cy )
{
    ASSERT(::IsWindow(m_hWnd));
    RECT rc = { 0 };
