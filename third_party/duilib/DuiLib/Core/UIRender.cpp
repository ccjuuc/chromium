...
namespace DuiLib {
	...
	void GdiplusDrawRoundRect(HDC hDC, float x, float y, float width, float height, float arcSize, float lineWidth, Gdiplus::Color lineColor, bool fillPath, Gdiplus::Color fillColor, int nStyle)
	{
		...
		roundRectPath.AddArc(x + width - arcDiameter, y, arcDiameter, arcDiameter, 270, 90);

		roundRectPath.AddLine(x + width, y + arcSize, x + width, y + height - arcSize);
		roundRectPath.AddArc(x + width - arcDiameter, y + height - arcDiameter, arcDiameter, arcDiameter, 0, 90);

		roundRectPath.AddLine(x + width - arcSize, y + height, x + arcSize, y + height);
		roundRectPath.AddArc(x, y + height - arcDiameter, arcDiameter, arcDiameter, 90, 90);

		roundRectPath.AddLine(x, y + height - arcSize, x, y + arcSize);
		roundRectPath.AddArc(x, y, arcDiameter, arcDiameter, 180, 90);
