...
inline constexpr char kInstallDirectory[] = "install-directory";
...
inline constexpr wchar_t kChromeDll[] = CUSTOM_CHROME_DLL_NAME_W;
#else
inline constexpr wchar_t kChromeDll[] = L"chrome.dll";
#endif

#if defined(CUSTOM_CHROME_EXE_NAME_W)
inline constexpr wchar_t kChromeExe[] = CUSTOM_CHROME_EXE_NAME_W;
#else
